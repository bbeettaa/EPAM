package ua.advanced.Practical6.autocode.observer.git;

import org.junit.Test;
import ua.advanced.Practical6.observer.git.Implementations.GitRepoObservers;
...
public class GitRepoObserversTest {
    ...
    public void readmeCase() {
        ...
        String b = commitReadmeWebHook.caughtEvents().toString();
        assertEquals(
