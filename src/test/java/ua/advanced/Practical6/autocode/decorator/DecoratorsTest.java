package ua.advanced.Practical6.autocode.decorator;

import org.junit.Test;
import ua.advanced.Practical6.decorator.Decorators;
...
public class DecoratorsTest {
    ...
    public void evenElementsSubListQwerty() {
        final List<String> list = new ArrayList<>( Arrays.asList("q,w,e,r,t,y,u,i,o,p".split(",")));
        final List<String> even = Decorators.evenIndexElementsSubList(list);
    ...
    public void evenElementsSubListAbc() {
        final List<String> list = new ArrayList<>(  Arrays.asList("a,b,c,d,e".split(",")));
        final List<String> even = Decorators.evenIndexElementsSubList(list);
