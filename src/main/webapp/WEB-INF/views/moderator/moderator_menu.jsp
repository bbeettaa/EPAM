...
<div class="container-fluid text-center">
    <div class="row content">
        <div class="col-sm-2 sidenav" style="height: 100%">
            <div class="well">
                <form method="post" action="moderatorMenu" style="margin-left: 10px">
            ...
            <div class="well">
                <form method="post" action="moderatorMenu" style="margin-left: 10px"><br>
                    <input type="hidden" name="action" value="moderatorMenu">
            ...
            <div class="well">
                <form method="post" action="createEventMenu" style="margin-left: 10px">
                <div class="createUser" >
                    <input type="hidden" name="action" value="createEventMenu">
                    <input type="submit" class="btn btn-default" value="<fmt:message key="title.createEvent"/>" name="Ok">
                </div>
                </form>
            ...
            <table class="table table-hover">
                ...
                <c:forEach var="entity" items="${requestScope.dao}">
                    ...
                    <ul>
                        ...
                        <td>
                            <form method="post" action="infoEvent" id="update">
                        ...
                        <td>
                            <form method="post" action="" id="dell">
                                ...
                                <input type="submit" value="<fmt:message key="label.button.delete"/>" class="btn btn-danger"/>
                            </form>
                        </td>
