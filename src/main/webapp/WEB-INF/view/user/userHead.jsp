...
<div class="header">
  <label style="margin-left: 45%"><fmt:message key="title.userPanel"/></label>
  <!-- logout -->
...
<%--      <option value="ru_RU" ${language == 'ru_RU' ? 'selected' : ''}>Русский</option>--%>
  ...
  <form style="margin-left: 150px" method="post" action="">
    <input type="hidden" name="action" value="subscribes"/>
    <ul class="nav" style="margin-top: -67px">
      <li><input style="width: 150px" type="submit" value="<fmt:message key="title.subscriptions"/>"></li>
    </ul>
  </form>
