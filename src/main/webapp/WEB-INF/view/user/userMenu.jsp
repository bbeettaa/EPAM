...
<div class="sidenav">
    ...
    <div class="search">
        <form method="post" action="" style="margin-left: 10px"><br>
            <input type="hidden" name="action" value="userMenu">
            <input type="radio" id="byName" name="sort" ${requestScope.sort == 'byName' ? "checked" : '' }
                   value="byName"><label for="byName"><fmt:message key="label.sort.byName"/></label><br>
            <input type="radio" id="byDate" name="sort" ${requestScope.sort == 'byDate' ? "checked" : '' }
                   value="byDate"><label for="byDate"><fmt:message key="label.sort.byDate"/></label><br>
            <input type="radio" id="byReports" name="sort" ${requestScope.sort == 'byReports' ? "checked" : '' }
                   value="byReports"><label for="byReports"><fmt:message key="label.sort.byReports"/></label><br>
            <input type="radio" id="bySubscribers" name="sort" ${requestScope.sort == 'bySubscribers' ? "checked" : '' }
                   value="bySubscribers"><label for="bySubscribers"><fmt:message
                    key="label.sort.bySubs"/></label><br><br>

            <input type="radio" id="asc" name="order" ${requestScope.order == 'asc' ? "checked" : '' }
                   value="asc"><label for="asc"><fmt:message key="label.sort.asc"/></label>
            <input type="radio" id="desc" name="order" ${requestScope.order == 'desc' ? "checked" : '' }
                   value="desc"><label for="desc"><fmt:message key="label.sort.desc"/></label><br>
                ...
                <ul>
                    ...
                    <td>
                        <form method="post" action="" id="subscribe">
                            ...
                            <input type="submit" value="<fmt:message key="label.button.subscribe"/>"/>
                        </form>
                    </td>
                    <td>
                        <c:choose>
