...
Task 5
        ...
        •  2 closed double fields sideA and sideB (sides А and В of the rectangle)
        •  Constructor with two double parameters a and b (parameters specify rectangle
        sides)
        •  Constructor with a double parameter a (parameter specify side А of a rectangle,
