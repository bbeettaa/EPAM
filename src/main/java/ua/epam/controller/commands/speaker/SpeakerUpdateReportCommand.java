...
public class SpeakerUpdateReportCommand implements ICommand {
    @Override
    ...
    private void setError(HttpServletRequest req, int repId, int eventId, IReport entity, String error) {
